...
final class Remote_Activation_Result {
	...
	public function to_array(): array { return array_merge(array('ok' => $this->http_status < 400, 'code' => $this->code, 'state' => $this->state), $this->payload); }
}
